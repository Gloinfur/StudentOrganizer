...
public class SaturdayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPrefs = this.getSharedPreferences("Saturday", MODE_PRIVATE);
    ...
    private void setUpView() {
        ...
        getSupportActionBar().setTitle("Time Table Saturday");
    ...
    protected void onStop() {
        super.onStop();
        sharedPrefsEditor = this.getSharedPreferences("Saturday", MODE_PRIVATE).edit();
