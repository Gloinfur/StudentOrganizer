...
public class FridayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPrefs = this.getSharedPreferences("Friday", MODE_PRIVATE);
    ...
    private void setUpView() {
        ...
        getSupportActionBar().setTitle("Time Table Friday");
    ...
    protected void onStop() {
        super.onStop();
        sharedPrefsEditor = this.getSharedPreferences("Friday", MODE_PRIVATE).edit();
