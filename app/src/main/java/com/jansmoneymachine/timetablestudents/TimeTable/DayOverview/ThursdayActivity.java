...
public class ThursdayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPrefs = this.getSharedPreferences("Thursday", MODE_PRIVATE);
    ...
    private void setUpView() {
        ...
        getSupportActionBar().setTitle("Time Table Thursday");
    ...
    protected void onStop() {
        super.onStop();
        sharedPrefsEditor = this.getSharedPreferences("Thursday", MODE_PRIVATE).edit();
