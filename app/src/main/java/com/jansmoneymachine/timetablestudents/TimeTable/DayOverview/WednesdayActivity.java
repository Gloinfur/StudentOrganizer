...
public class WednesdayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPrefs = this.getSharedPreferences("Wednesday", MODE_PRIVATE);
    ...
    private void setUpView() {
        ...
        getSupportActionBar().setTitle("Time Table Wednesday");
    ...
    protected void onStop() {
        super.onStop();
        sharedPrefsEditor = this.getSharedPreferences("Wednesday", MODE_PRIVATE).edit();
